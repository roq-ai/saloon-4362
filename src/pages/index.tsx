  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Saloon - Streamlining Your Project Management Needs. Experience the ease of administration with Saloon Project Admin."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1485686531765-ba63b07845a7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzYWxvb258ZW58MHx8fHwxNjkxMjY2OTAwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Saloon - Streamlining Your Project Management Needs. Experience the ease of administration with Saloon Project Admin.`}
            </Text>
            <Box
