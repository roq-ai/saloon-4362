...
type ColumnType = ColumnDef<SalonInterface, unknown>;
...
export function SalonListPage(props: SalonListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<SalonInterface>>(
    () => `/salons?params=${JSON.stringify(params)}`,
    fetcher,
  );
      ...
      : null,
    {
      ...
      cell: ({ row: { original: record } }: any) => (
        <Flex justifyContent="flex-end">
          <NextLink href={`/salons/view/${record.id}`} passHref legacyBehavior>
            <Button
